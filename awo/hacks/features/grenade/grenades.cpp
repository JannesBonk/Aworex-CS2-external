...
__forceinline static void AngleVectors( const awo::vec3_t& angles, awo::vec3_t& forward, awo::vec3_t* right /* nullptr */, awo::vec3_t* up /* nullptr */ ) {
...
void awo::grenade_t::run( const c_entity& local_player, const c_entity& entity, int local_index, int index ) {
	/* sanity */
	...
	if ( local_player.player_pawn.weapon_type != awo::cs_weapon_type::weapon_type_grenade ) {
		return;
	}
