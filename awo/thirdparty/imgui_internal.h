...
struct IMGUI_API ImGuiWindow
{
    ...
    ImRect                  ClipRect;                           // Current clipping/scissoring rectangle, awolve as we are using PushClipRect(), etc. == DrawList->clip_rect_stack.back().
...
struct IMGUI_API ImGuiTable
{
    ...
    ImRect                      BgClipRect;                 // We use this to cpu-clip cell background color fill, awolve during the frame as we cross frozen rows boundaries
...
// This structure is likely to awolve as we add support for incremental atlas updates
