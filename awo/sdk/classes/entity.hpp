...
namespace awo {
	...
	public:
		...
		int shots_fired{};
		vec2_t screen_pos{};
		vec2_t aim_punch_angle{};
		c_utlvector aim_punch_cache{};
	...
	public:
		...
		__forceinline bool _shots_fired() {
			return mem::scan_memory<int>("c_player_pawn::shotsfire", this->address, 0x1420, this->shots_fired);
		}


		__forceinline bool _aim_punch_angle() {
			return mem::scan_memory<vec2_t>("c_player_pawn::aimpunchangl", this->address, 0x171C, this->aim_punch_angle);
		}

		__forceinline bool _aim_punch_cache() {
			return mem::scan_memory<c_utlvector>("c_player_pawn::aimpunchcach", this->address, 0x1740, this->aim_punch_cache);
		}
	...
	public:
...
#if 0
				/* debug */
				printf( "[awo] player controller is 0\n" );
#endif 
				return false;
			}
...
#if 1
				/* debug */
				printf( "[awo] error controller._alive\n" );
#endif 
				return false;
			}
...
#if 1
				/* debug */
				printf( "[awo] error controller._health\n" );
#endif 
				return false;
			}
...
#if 1
				/* debug */
				printf( "[awo] error controller._team_id\n" );
#endif 
				return false;
			}
...
#if 1
				/* debug */
				printf( "[awo] error controller._player_name\n" );
#endif 
				return false;
			}
...
#if 0
			/* debug */
			printf( "[awo] c_entity::update_controller ran succesfully\n" );
#endif
			return true;
		}
...
#if 1
				/* debug */
				printf( "[awo] error controller._pos\n" );
#endif 
...
#if 1
				/* debug */
				printf( "[awo] error controller._spotted\n" );
#endif 
...
#if 1
				/* debug */
				printf( "[awo] error controller._hemlet\n" );
#endif 
...
#if 1
				/* debug */
				printf( "[awo] error bone_data.update_bone_data\n" );
#endif 
				return false;
			}
...
#if 1
				/* debug */
				printf( "[awo] player address is 0\n" );
#endif 
				return bone_t{};
			}
		...
		__forceinline bool in_screen( ) {
			return awo::_address->view.world_to_screen( this->player_pawn.pos, this->player_pawn.screen_pos );
		}
	};
