...
namespace evo {
	namespace offsets {
		namespace c_base_entity {
			inline DWORD health = 0x334;
			inline DWORD team_id = 0x3CB;
			inline DWORD vec_velocity = 0x3E8;
			inline DWORD game_scene_node = 0x318;
		...
		namespace c_base_player_controler {
			inline DWORD player_pawn = 0x7E4;
			inline DWORD pawn_alive = 0x7EC;
			inline DWORD player_name = 0x638;
			inline DWORD ping = 0x718;

			inline DWORD has_hemlet = 0x7F9;
			inline DWORD has_defuser = 0x7F8;
		}

		namespace pawn {
			inline DWORD health = 0x334;
			inline DWORD vec_old_origin = 0x127C;
			inline DWORD dormant = 0xE7;
			inline DWORD viewangle = 0x1518;
			inline DWORD camera_pos = 0x12EC;
			inline DWORD ping_services = 0x12C0;
			inline DWORD camera_services = 0x1138;
			inline DWORD processing_value = 0x120;

			inline DWORD max_alpha = 0x14C8;
			inline DWORD flash_Duration = 0x14CC;
			...
			inline DWORD spotted = 0x1698 + 0xC; /* xref: m_entitySpottedState + m_bSpottedByMask  */
		}
		...
		namespace item_services {
			inline DWORD item_services_pawn = 0x1108;
		...
		namespace c_base_weapon {
			inline DWORD clipping_weapon = 0x1308;
			inline DWORD wpn_data_ptr = 0x368;
			inline DWORD weapon_services = 0x1100;
			inline DWORD active_weapon = 0x60;
			inline DWORD clip_1 = 0x15C8;
			inline DWORD cycle_time = 0xC44;
		...
		namespace match_making {
			inline DWORD m_i_competitive_ranking = 0x768; // int32_t
			inline DWORD m_i_competitive_wins = 0x76C; // int32_t
			inline DWORD m_i_competitive_rank_type = 0x770; // int8_t
			inline DWORD m_i_competitive_ranking_predicted_win = 0x774; // int32_t
			inline DWORD m_i_competitive_ranking_predicted_loss = 0x778; // int32_t
			inline DWORD m_i_competitive_ranking_predicted_tie = 0x77C; // int32_t
		}
	...
	namespace signatures {
		...
		const std::string view_angles = "48 8B 0D ?? ?? ?? ?? E9 ?? ?? ?? ?? CC CC CC CC 48 C7 02";
		...
		const std::string force_jump = "48 8D 05 ?? ?? ?? ?? 48 89 4D ?? 48 89 45 ?? 48 8D 05 ?? ?? ?? ?? 48 89 45 ?? 48 8D 05 ?? ?? ?? ?? 48 89 45 ?? 48 8D 05 ?? ?? ?? ?? 48 89 45 ?? 48 8D 05 ?? ?? ?? ?? 48 89 45 ?? 48 8D 05 ?? ?? ?? ?? 48 89 45 ?? 48 8D 05 ?? ?? ?? ?? 48 89 45 ?? 4C 6B E3";
